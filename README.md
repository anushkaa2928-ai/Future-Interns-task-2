...
This project focuses on the analysis of phishing emails to identify common indicators, classify risk levels, and assess their potential impact. It aims to improve awareness and understanding of phishing techniques and highlights preventive measures to reduce the risk of cyber attacks.

Contents

1. PHISHING EMAIL DETECTION AND AWARENESS REPORT
   
2. Public email samples
